...
class E2E extends Simulation {
	...
	setUp(
		...
		VerizonNewActivationE2EComponents.VerizonNewActivationE2EFlow.inject(rampUsers(SimParams.VNA) over (SimParams.rampup seconds)).protocols(SimParams.httpProtocol),
