...
object Common{
	...
	val Upgrade=group("Choose Path"){
		exec(http("To Upgrade #34")
			...
			.exec(http("To Upgrade #46")
				.post(uri_dsom + "/dsom-app/v1/getContentForAisle")
				.headers(SprintUpgradeE2EHeaders.headers_45)
				.body(ElFileBody("sprint/UpgradeE2E/SprintUpgradeE2E_0045_request.json")).asJSON)
			.exec(http("To Upgrade #47")
				.post(uri_dsom + "/dsom-app/v1/getNextState")
				.headers(SprintUpgradeE2EHeaders.headers_46)
				.body(ElFileBody("sprint/UpgradeE2E/SprintUpgradeE2E_0046_request.json")).asJSON)
			.exec(http("To Upgrade #48")
				.options(uri_dsom + "/dsom-app/v1/getContentForAisle")
				.headers(SprintUpgradeE2EHeaders.headers_7))
			.exec(http("To Upgrade #50")
				.post(uri_dsom + "/dsom-app/v1/getContentForAisle")
				.headers(SprintUpgradeE2EHeaders.headers_49)
				.body(ElFileBody("sprint/UpgradeE2E/SprintUpgradeE2E_0049_request.json")).asJSON
				.resources(http("To Upgrade #35")
					.post(uri_dsom + "/dsom-app/v1/getNextState")
					.headers(SprintUpgradeE2EHeaders.headers_35)
					.body(ElFileBody("sprint/UpgradeE2E/SprintUpgradeE2E_0035_request.json")), http("To Upgrade #36")
					...
					.get(uri_ui + "/build/css_977b366a07134c693178_min.js")
					.headers(SprintUpgradeE2EHeaders.headers_1), http("To Upgrade #38")
					.get(uri_ui + "/build/bundle_977b366a07134c693178_min.js")
					...
					.get(uri_ui + "/build/ch_523e04986e5df68da3af_min.js")
					...
					.get(uri_ui + "/app/pages/accountverification/accountverification.html")
					...
					.get(uri_ui + "/assets/img/att.svg")
					.headers(SprintUpgradeE2EHeaders.headers_3), http("To Upgrade #58")
					.get(uri_ui + "/assets/img/sprint.svg")
